    ...
    <div class="table">
        <table id="customerTable">
            ...
            @foreach($agents as $agent)
                    ...
                    <tr>
                        <td><a href="{{route('viewAgtProfile',['id'=>$agent->id])}}">{{ $agent->id }}</a></td>
                        <td><a href="{{route('viewAgtProfile',['id'=>$agent->id])}}">{{ $agent->MTR_NameInitials }}</a></td>
                        <td><a href="{{route('viewAgtProfile',['id'=>$agent->id])}}">{{ $agent->MTR_NIC }}</a></td>
                        <td><a href="{{route('viewAgtProfile',['id'=>$agent->id])}}">{{ $agent->MTR_Phone1 }}</a></td>
                        <td><a href="{{route('viewAgtProfile',['id'=>$agent->id])}}">{{ $agent->created_at }}</a></td>
                        <td><a href="{{route('viewAgtProfile',['id'=>$agent->id])}}">{{ $agent->MTR_Address }}</a></td>
                        <td><a href="{{route('viewAgtProfile',['id'=>$agent->id])}}">{{ $agent->MTR_DOB }}</a></td>
                        <td><a href="{{route('viewAgtProfile',['id'=>$agent->id])}}">{{ $agent->MTR_Remark }}</a></td>
